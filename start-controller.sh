...
#Run the image
docker run -d --name jenkins -e JENKINS_OPTS="--httpPort=8081" -e JENKINS_HOST_URL="http://127.0.0.1:8081" -e JENKINS_ADMIN_USER=admin -e JENKINS_ADMIN_PASSWORD="password" -e GITHUB_USER="rene@zubcevic.com" -e JENKINS_ADMIN_EMAIL="rene@zubcevic.com" -e GITHUB_PK="${SSH_PK}" -p 8080:8081 -p 50000:50000 renezubcevic/jenkins-controller:latest
